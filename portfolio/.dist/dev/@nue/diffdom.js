...
function checkElementType(element, simplifiedCheck) {
  ...
  return elementTypeNames.some(function(elementTypeName) {
    var _a, _b;
    return typeof ((_b = (_a = element === null || element === undefined ? undefined : element.ownerDocument) === null || _a === undefined ? undefined : _a.defaultView) === null || _b === undefined ? undefined : _b[elementTypeName]) === "function" && element instanceof element.ownerDocument.defaultView[elementTypeName];
  });
}
...
function applyVirtualDiff(tree, diff, options) {
  ...
  switch (diff[options._const.action]) {
    ...
    case options._const.addElement: {
      ...
      node = (_a = getFromVirtualRoute(tree, route)) === null || _a === undefined ? undefined : _a.node;
  ...
  html.replace(tagRE, function(tag, index) {
    ...
    if (!isOpen || current.voidElement) {
      ...
      if (nextChar !== "<" && nextChar) {
        ...
        var data = unescape(html.slice(start, end2 === -1 ? undefined : end2));
        childNodes.push({
          nodeName: "#text",
          data
        });
...
var $nodeToObj = nodeToObj;
var $stringToObj = stringToObj;
export {
  $stringToObj as stringToObj,
  $nodeToObj as nodeToObj,
  $TraceLogger as TraceLogger,
  $DiffDOM as DiffDOM
};
